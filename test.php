...
// ******** เพิ่มโค้ดเพื่อรับค่า sort จาก URL ********
$sortBy = $_GET['sort'] ?? 'latest'; // Default เป็น 'latest' ถ้าไม่มีค่าใน URL
// *************************************************
...
                <?php } ?>
                ...
                <div class="flex space-x-2 mb-4 w-full max-w-md mx-auto">
                    <a href="?sort=latest" class="
                        <?= ($sortBy === 'latest' || $sortBy === '') ? 'btn-blue-500-full' : 'btn-gray-300-full' ?>
                    ">
                        <i class="fa-solid fa-clock"></i> โพสต์ล่าสุด
                    </a>
                    <a href="?sort=most_loved" class="
                        <?= ($sortBy === 'most_loved') ? 'btn-red-500-full' : 'btn-gray-300-full' ?>
                    ">
...
                        <?php
                        // ******** ส่งตัวแปร $sortBy เข้าไปในฟังก์ชัน ********
...
                                                <span class="heart-icon fa-lg"><?php echo userHasLoved($conn, $post['postId'], $_SESSION['userId']) ? "<i class='text-red-400 fa-solid fa-heart'></i>" : "<i class='text-red-300 fa-solid fa-heart'></i>"; ?></span>
                                            </button>
...
                                </div>
                            <?php } 
                            // เพิ่มข้อความแจ้งเตือนถ้าไม่มีโพสต์
                            else { ?>
                                <div class='alert-info text-center'>ไม่พบโพสต์ในขณะนี้</div>
                            <?php } ?>
                        <?php } ?>
                    </div>
                </div>
